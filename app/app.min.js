...
app.lightBoxNav = function lightBoxNav() {
    ...
    nav.querySelector("li:last-child>.partial-link").addEventListener("keydown", app.focusFirstLink);
};
...
function carousel() {
    ...
    document.getElementById("carouselNavNext").addEventListener("click", function() {
        carouselNext(document.getElementsByClassName("carousel-img"));
    });
    document.getElementById("carouselNavPrev").addEventListener("click", function() {
